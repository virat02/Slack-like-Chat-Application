...
public class GroupController implements IController<Group>{
	...
	private static final String GROUP_NOT_PERSISTED_JSON = "{\"message\" : \"Sorry, could not create the group! Please try again.\"}";
	...
	private static final String GROUP_NOT_DELETED_JSON = "{\"message\" : \"Sorry, could not delete the group! Please try again.\"}";
